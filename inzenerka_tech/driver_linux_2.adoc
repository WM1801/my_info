...
/* Функция выгрузки (выполняется при rmmod)*/
static void __exit my_exit(void)
{
    printk(KERN_INFO "Модуль выгружается. Освобождаем ресурсы...\n");
    
    // Здесь мы ОБЯЗАНЫ освободить всё, что выделили в my_init:
    // kfree(), unregister_chrdev(), free_irq() и т.д.
}

module_init(my_init);
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Твое Имя");
MODULE_DESCRIPTION("Демонстрационный модуль с параметрами и выгрузкой");
----
